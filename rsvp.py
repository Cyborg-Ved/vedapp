...
# If you do not want to configure a different SESSION_TYPE, this will be used to generate nicer error messages. 
# Will allow read-only access to the empty session but fail on setting.
